...
public class PersonGenerator
{
    ...
    public static void main(String[] args)
    {
        ...
        while(response)
        {
            idNo = SafeInput.getNonZeroLenString(in,"What is this person's ID Number?");
            fName = SafeInput.getNonZeroLenString(in,"What is this person's first name?");
            lName = SafeInput.getNonZeroLenString(in,"What is this person's last name?");
            ...
            recs.add(new Person(idNo,fName,lName,title,yob));
